...
def fetch_trending_movies(count=6):
    try:
        url = "https://api.themoviedb.org/3/trending/movie/week?api_key=84e0a0d7687f8311b784966ac9e8ab45"
...
# 🔎 Clean title by removing year (e.g., "The Matrix (1999)" -> "The Matrix")
...
def get_poster(title):
    try:
        ...
        url = f"https://api.themoviedb.org/3/search/movie?api_key=84e0a0d7687f8311b784966ac9e8ab45&query={query_title}"
